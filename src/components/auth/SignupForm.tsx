...
import { ArrowRight, CheckCircle, Eye, EyeOff, Loader2, Lock, Mail, User, UserPlus } from 'lucide-react'
...
const SignupForm: React.FC = () => {
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    const success = await signup(data.name, data.email, data.password, data.acceptPrivacyPolicy)
    if (success) {
        ...
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 w-6 h-6 bg-blue-400 rounded-full border-2 border-white animate-pulse"></div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-3">
                ...
                />
                <label htmlFor="acceptPrivacyPolicy" className="text-sm text-gray-700 leading-relaxed">
                  I agree to the{' '}
                  <Link 
                    href="/privacy" 
                    target="_blank"
                  ...
                  and consent to the collection, use, and processing of my personal data as described therein.
                </label>
              </div>
