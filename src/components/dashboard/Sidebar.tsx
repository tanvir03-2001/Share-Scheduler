...
export default function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  return (
    <div className="fixed left-0 top-0 w-64 bg-white shadow-lg border-r border-gray-200 h-screen flex flex-col z-40">
      <div className="p-4 border-b border-gray-200">
        <h2 className="text-lg font-bold text-gray-900">Content Studio</h2>
      </div>
