    ...
    <div>
            ...
            <div className="flex items-start space-x-4">
              ...
              {item.imageUrl && (
                <div className="flex-shrink-0">
                  <div className={`${type === 'reel' ? 'w-20 h-28' : 'w-20 h-20'} bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden`}>
                    {type === 'reel' ? (
      ...
      {content.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">Create your first {type} to get started.</p>
